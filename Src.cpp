...
#define MAXFILESIZE 2048   //for file size

#define REGULAR 1         //file type
#define SPECIAL 2

#define START 0           //for lseek function
#define CURRENT 1
#define END 2
...
void man(char *name)
{
    ...
    if(strcmp(name,"create")==0)
    {
        ...
        printf("Usage : creat File_name Permition \n");
    }
    else if(strcmp(name,"read")== 0)
    {
        printf("Description :Used to read the data from reguler file \n");
        printf("Usage : read File_name No_Of_Bytes_To_Read\n");
    }
    else if(strcmp(name,"write")==0)
    {
        printf("Description :Used to write into reguler file\n");
    ...
    {
         printf("Description :Used to display informatio of file\n");
        printf("Usage : stat File_Descriptor\n");
    }
...
void DisplayHelp()
{
    ...
    printf("write   :To Read the contents from file \n");
...
int CreateFile(char *name, int permission)  //creat    hello.txt    3
{
    int i =0;
    PINODE temp = head;
    ...
    while(1)
    {
        ...
        if(count == 1)
        {
            ...
            else if(strcmp(command[0],"clear") == 0)
           {
            ...
            {
               printf("Terminating the G1's Virtual File System\n");
               break;
            }
            else
           {
                           ...
                           ret = ReadFile(fd,ptr,atoi(command[2]));
                            if(ret == -1)
                             ...
                             if(ret == -2)
                                 printf("ERROR : Permission denied \n");
                              if(ret == -3)
                                  printf("ERROR : Reatch at end of file \n");
                             if(ret == -4)
                                  printf("ERROR : It is not a reguler file\n");
                             if(ret == 0)
